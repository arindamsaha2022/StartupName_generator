...
app.post("/submit", (req, res) => {
  ...
  const generatedNoun = noun [Math.floor(Math.random()*noun.length)]
  const generatedAdj = adj [Math.floor(Math.random()*adj.length)]

  console.log(generatedNoun +"-"+generatedAdj )
  res.render("index.ejs",{
     adjective: generatedAdj,
     noun: generatedNoun,
  })
